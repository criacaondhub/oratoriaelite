                    ...
                    >
                        <div className="flex flex-col gap-[20px] xl:gap-[1.5625vw] w-fit">
                            {[
                                ...
                                { text: "ECONOMIA DE: ", price: "R$ 1.242,50", highlight: true }
                            ].map((item, i) => (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center md:gap-[0.8333vw] gap-4">
                                ...
                                <span className="text-white font-body text-[16px] md:text-[1.2500vw] font-medium transition-all">Ou apenas R$ 248,50 à vista</span>
                            </div>
...
export default LastNoticePricing
