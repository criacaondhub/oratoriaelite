                    ...
                    >
                        <div className="flex flex-col gap-[20px] xl:gap-[1.5625vw] w-fit">
                            {[
                                ...
                                { text: "ECONOMIA DE: ", price: "R$ 794,00", highlight: true }
                            ].map((item, i) => (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center md:gap-[0.8333vw] gap-4">
                                ...
                                <span className="text-white font-body text-[16px] md:text-[1.2500vw] font-medium transition-all">Ou apenas R$ 697,00 à vista</span>
                            </div>

                            {/* Button - Styled like Hero CTA */}
                            <motion.a
                                href="https://pay.hub.la/429oWWbOw4v6vE3KyhlX"
                                target="_blank"
