            ...
            <section className="relative w-full min-h-[calc(100vh-60px)] flex flex-col items-center justify-start md:justify-center overflow-hidden pt-10 pb-12 md:py-20">
                <div className="container mx-auto px-6 lg:px-12 relative z-10 flex flex-col items-center">
                    ...
                    >
                        ...
                        {/* CTA */}
                        <div className="flex flex-col items-center gap-4 w-full mt-4" style={{ fontFamily: 'DM Sans', cursor: 'pointer' }}>
                            <div
                            ...
                            <div
                                ...
                                style={{ textDecoration: 'underline', lineHeight: '22px', fontSize: '16px', fontWeight: 700, color: 'rgb(227, 227, 227)', textAlign: 'center' }}
                                id="denyButton048a994"
                                onClick={() => {
