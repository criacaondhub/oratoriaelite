...
export default function LastNoticeHero() {
    return (
                    ...
                    >
                        ...
                        <div 
                            ...
                            dangerouslySetInnerHTML={{ __html: `
                                <div id="ifr_69b30e5cd04b0a3cfd7df0d8_wrapper" style="margin: 0 auto; width: 100%; "> 
                                    <div style="position: relative; padding: 56.25% 0 0 0;" id="ifr_69b30e5cd04b0a3cfd7df0d8_aspect"> 
                                        <iframe frameborder="0" allowfullscreen src="about:blank" id="ifr_69b30e5cd04b0a3cfd7df0d8" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" referrerpolicy="origin" onload="this.onload=null, this.src='https://scripts.converteai.net/69acc469-7ca6-4905-a042-9dae89c1548f/players/69b30e5cd04b0a3cfd7df0d8/v4/embed.html' +(location.search||'?') +'&vl=' +encodeURIComponent(location.href)"></iframe> 
                                    </div> 
                                </div>
                            `}}
                        />
                        ...
                        <div className="flex flex-col items-center gap-4 w-full mt-4">
                            <motion.a
                                href="https://pay.hub.la/osdhwUyUrGeA57IQ2ALv/upsell"
                                target="_blank"
                            ...
                            <a
                                href="https://elprofessordaoratoria.com.br/inscricao-evento-concluida"
