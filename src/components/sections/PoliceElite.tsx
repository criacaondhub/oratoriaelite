...
const PoliceElite = () => {
    return (
        <section className="relative w-full py-12 md:py-24 bg-transparent overflow-hidden font-body">
            <div className="container mx-auto px-6 lg:px-16 relative z-10 flex flex-col items-center mb-10 md:mb-24">
                ...
                <motion.h2
                    ...
                    viewport={{ once: true }}
                    className="text-center text-[28px] md:text-[2.5000vw] font-extrabold md:font-extrabold font-heading text-white uppercase leading-[1.2] md:leading-[1.1] max-w-5xl"
                >
